-- Make role assignment concurrency-safe to avoid duplicate-key crashes.
-- Uses an advisory lock keyed by target_user_id.
...
BEGIN
  ...
  -- Serialize role changes per target user
